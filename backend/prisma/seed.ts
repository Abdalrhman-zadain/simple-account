...
async function main() {
  ...
  // Inventory Item Groups and Categories
  await prisma.inventoryItemGroup.createMany({
    data: [
      {
        code: 'RAW',
        name: 'مواد خام',
        description: 'مواد أولية يتم شراؤها واستخدامها في التصنيع أو التشغيل',
        parentGroupId: null,
        isActive: true,
      ...
      {
        code: 'FINISHED',
        name: 'مواد جاهزة للبيع',
        description: 'مواد ومنتجات جاهزة يتم بيعها مباشرة للعملاء',
        parentGroupId: null,
        isActive: true,
        inventoryAccountId: null,
        cogsAccountId: null,
      ...
      },
      {
        code: 'MANUFACTURED',
        name: 'مواد مصنّعة',
        description: 'منتجات يتم تصنيعها داخليًا من مواد خام أو مكونات أخرى',
        parentGroupId: null,
        isActive: true,
        inventoryAccountId: null,
        cogsAccountId: null,
      ...
      },
      {
        code: 'SERVICES',
        name: 'خدمات',
        description: 'خدمات غير مخزنية يتم بيعها بدون تأثير مباشر على المخزون',
        parentGroupId: null,
        isActive: true,
        inventoryAccountId: null,
        cogsAccountId: null,
      ...
      },
      {
        ...
        description: 'مواد تستخدم للتغليف والتعبئة مثل الكراتين والعبوات والملصقات',
        parentGroupId: null,
        isActive: true,
        inventoryAccountId: null,
        cogsAccountId: null,
      ...
      {
        code: 'SPARE_PARTS',
        name: 'قطع غيار ومستلزمات',
        description: 'قطع غيار أو مستلزمات تشغيلية يتم الاحتفاظ بها في المخزون',
        parentGroupId: null,
        isActive: true,
        inventoryAccountId: null,
        cogsAccountId: null,
  ...
  const getItemGroupId = (code: string) =>
    itemGroups.find((itemGroup) => itemGroup.code === code)?.id ?? '';
    ...
    data: [
      {
        code: 'RAW_GENERAL',
        name: 'مواد خام عامة',
        description: 'فئة عامة للمواد الخام',
        itemGroupId: getItemGroupId('RAW'),
        isActive: true,
      },
      {
        code: 'RAW_CHEMICALS',
        name: 'مواد كيميائية خام',
        description: 'مواد كيميائية أو مركبات أولية تستخدم في الإنتاج',
        itemGroupId: getItemGroupId('RAW'),
        isActive: true,
      },
      {
        code: 'RAW_FABRIC',
        name: 'أقمشة ومواد نسيجية',
        description: 'مواد خام مثل الأقمشة والخيوط والمواد النسيجية',
        itemGroupId: getItemGroupId('RAW'),
        isActive: true,
      },
      {
        code: 'FINISHED_GENERAL',
        name: 'منتجات جاهزة عامة',
        description: 'منتجات جاهزة للبيع بشكل مباشر',
        itemGroupId: getItemGroupId('FINISHED'),
        isActive: true,
      },
      {
        code: 'FINISHED_CLEANING',
        name: 'منتجات تنظيف',
        description: 'منتجات تنظيف جاهزة للبيع مثل المنظفات والمعقمات',
        itemGroupId: getItemGroupId('FINISHED'),
        isActive: true,
      },
      {
        code: 'FINISHED_OFFICE',
        name: 'أثاث ومستلزمات مكتبية',
        description: 'منتجات مكتبية جاهزة للبيع مثل الكراسي والطاولات',
        itemGroupId: getItemGroupId('FINISHED'),
        isActive: true,
      },
      {
        code: 'MFG_GENERAL',
        name: 'منتجات مصنّعة عامة',
        description: 'منتجات يتم تصنيعها داخليًا',
        itemGroupId: getItemGroupId('MANUFACTURED'),
        isActive: true,
      },
      {
        code: 'MFG_ASSEMBLED',
        name: 'منتجات مجمّعة',
        description: 'منتجات يتم تجميعها من عدة مكونات أو مواد خام',
        itemGroupId: getItemGroupId('MANUFACTURED'),
        isActive: true,
      },
      {
        code: 'SERVICE_GENERAL',
        name: 'خدمات عامة',
        description: 'خدمات عامة غير مخزنية',
        itemGroupId: getItemGroupId('SERVICES'),
        isActive: true,
      },
      {
        code: 'SERVICE_INSTALLATION',
        name: 'خدمات تركيب',
        description: 'خدمات تركيب أو تجهيز تقدم للعملاء',
        itemGroupId: getItemGroupId('SERVICES'),
        isActive: true,
      },
      {
        ...
        name: 'خدمات صيانة',
        description: 'خدمات صيانة أو دعم فني',
        itemGroupId: getItemGroupId('SERVICES'),
        isActive: true,
      },
      {
        code: 'PACK_BOXES',
        name: 'كراتين وصناديق',
        description: 'مواد تعبئة مثل الكراتين والصناديق',
        itemGroupId: getItemGroupId('PACKAGING'),
        isActive: true,
      },
      {
        code: 'PACK_BOTTLES',
        name: 'عبوات وقوارير',
        description: 'عبوات بلاستيكية أو زجاجية أو معدنية',
        itemGroupId: getItemGroupId('PACKAGING'),
        isActive: true,
      },
      {
        code: 'PACK_LABELS',
        name: 'ملصقات وتغليف',
        description: 'ملصقات ومواد تغليف خارجية',
        itemGroupId: getItemGroupId('PACKAGING'),
        isActive: true,
      },
      {
        code: 'SPARE_GENERAL',
        name: 'قطع غيار عامة',
        description: 'قطع غيار ومستلزمات عامة',
        itemGroupId: getItemGroupId('SPARE_PARTS'),
        isActive: true,
      },
      {
        code: 'SPARE_TOOLS',
        name: 'أدوات ومستلزمات تشغيل',
        description: 'أدوات ومستلزمات تستخدم في التشغيل أو الصيانة',
        itemGroupId: getItemGroupId('SPARE_PARTS'),
        isActive: true,
      },
    ],
