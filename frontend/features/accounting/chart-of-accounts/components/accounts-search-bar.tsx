      ...
      <div className="relative w-full">
        <div className="group relative">
          ...
          <Input
            ...
            onBlur={() => window.setTimeout(onHideSuggestions, 100)}
          ...
          {searchQuery && (
            <button
              ...
              className="absolute right-3 top-1/2 rounded-md p-1 text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-900"
            >
              <X className="h-4 w-4" />
            </button>
          )}
