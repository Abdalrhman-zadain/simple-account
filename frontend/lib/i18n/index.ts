...
const enTranslations: Record<string, string> = {
  ...
  "accounts.search.placeholder":
    "Search or choose a filter suggestion...",
  "accounts.suggestions.title": "Suggestions",
  "accounts.suggestion.category.filter": "Filter",
  "accounts.suggestion.type.ASSET": "Type: Asset",
  "accounts.suggestion.type.LIABILITY": "Type: Liability",
  "accounts.suggestion.type.EQUITY": "Type: Equity",
  "accounts.suggestion.type.REVENUE": "Type: Revenue",
  "accounts.suggestion.type.EXPENSE": "Type: Expense",
  "accounts.suggestion.role.posting": "Role: Posting",
  "accounts.suggestion.role.header": "Role: Header",
  "accounts.suggestion.status.active": "Status: Active",
  "accounts.suggestion.status.inactive": "Status: Inactive",
  ...
  "master.section.taxes.title": "Tax",
  ...
  "master.taxes.saveError": "Failed to save tax.",
  "master.taxes.deleteError": "Failed to delete tax.",
  ...
  "master.taxes.empty": "No taxes yet. Add a tax to start.",
  "master.taxes.error": "Could not load taxes.",
  "master.taxes.taxCode": "Code",
  "master.taxes.taxName": "Tax Name",
  "master.taxes.rate": "Rate",
  "master.taxes.taxType": "Type",
  "master.taxes.taxAccount": "Tax Account",
  "master.taxes.noAccount": "No account",
  "master.taxes.modal.createTitle": "Add Tax",
  "master.taxes.modal.editTitle": "Edit Tax",
  "master.taxes.codePlaceholder": "VAT16",
  "master.taxes.namePlaceholder": "Sales Tax 16%",
  "master.taxes.accountPlaceholder": "Select tax account",
  "master.taxes.active": "Active",
  "master.taxes.inactive": "Inactive",
  "master.taxes.type.SALES": "Sales",
  "master.taxes.type.PURCHASE": "Purchase",
  ...
  "master.paymentTerms.add": "Add Payment Term",
  "master.paymentTerms.empty": "No payment terms yet. Add a payment term to start.",
  "master.paymentTerms.name": "Name",
  "master.paymentTerms.calculationMethod": "Due Date Calculation",
  "master.paymentTerms.numberOfDays": "Number of Days",
  "master.paymentTerms.active": "Active",
  "master.paymentTerms.inactive": "Inactive",
  "master.paymentTerms.nameEnglish": "Name (English)",
  "master.paymentTerms.nameEnglishPlaceholder": "e.g., Net 30",
  "master.paymentTerms.nameArabic": "Name (Arabic)",
  "master.paymentTerms.nameArabicPlaceholder": "e.g., خلال 30 يومًا",
  "master.paymentTerms.method.immediate": "Immediate",
  "master.paymentTerms.method.daysAfter": "Days After",
  "master.paymentTerms.method.endOfMonth": "End of Month",
  "master.paymentTerms.method.manual": "Manual",
  "master.paymentTerms.modal.createTitle": "Add Payment Term",
  "master.paymentTerms.modal.editTitle": "Edit Payment Term",
  "master.paymentTerms.saveError": "Failed to save payment term.",
  "master.paymentTerms.deleteError": "Failed to delete payment term.",
  ...
  "common.confirm.delete": 'Delete "{name}"?',
...
Object.assign(enTranslations, {
  ...
  "purchases.action.convertToInvoice": "Convert to Draft Purchase Invoice",
  "purchases.action.backToRequests": "Back to Requests",
  ...
  "purchases.placeholder.autoGenerated": "Auto-generated",
  ...
  "purchases.status.submitted": "Pending Approval",
  ...
  "purchases.requests.section.linkedInvoices": "Linked Purchase Invoices",
  "purchases.requests.section.editorLines": "Request Lines",
  "purchases.requests.section.description": "Create or edit internal purchase requests by specifying items, quantities, requirements, and notes.",
  "purchases.requests.section.editorLinesDescription": "Add request lines with item details, quantities, descriptions, and required delivery dates.",
  ...
  "purchases.requests.metric.linkedDocuments": "Linked Documents",
  ...
  "purchases.requests.empty.linkedInvoices":
    "No linked purchase invoices yet.",
  ...
  "purchases.requests.empty.selectItemOrService": "Select an item or service",
  "purchases.requests.state.loadingDetails": "Loading purchase request details...",
  "purchases.requests.history.byUser": "By {user}",
  "purchases.requests.history.systemUser": "System",
...
Object.assign(enTranslations, {
  ...
  "purchases.orders.section.description": "Create or edit purchase orders by specifying the supplier, items, quantities, prices, and terms.",
  "purchases.orders.section.editorLinesDescription": "Add order lines with item details, quantities, unit prices, and accounting account mappings.",
...
Object.assign(enTranslations, {
  ...
  "purchases.invoices.field.sourceRequest": "Source Purchase Request",
...
Object.assign(enTranslations, {
  ...
  "reporting.toolbar.title": "Report Tools",
  "reporting.toolbar.saveDefinition": "Save Definition",
  "reporting.toolbar.selectDefinition": "Select Saved",
  "reporting.toolbar.saveSnapshot": "Save Snapshot",
  "reporting.toolbar.viewSnapshots": "View Snapshots",
  "reporting.toolbar.print": "Print",
  "reporting.toolbar.export": "Export",
  "reporting.loading": "Loading reporting workspace...",
  "reporting.empty": "No report data is available for the selected filters.",
  "reporting.emptyPostedHint": "Official financial reports show posted ledger activity only. Purchase requests and purchase orders do not create financial entries by themselves.",
  "reporting.error": "We couldn't load this report.",
  "reporting.errorHint": "Check the active filters, make sure the backend and database are running, and verify there are posted transactions in the selected period.",
...
Object.assign(enTranslations, {
  "nav.item.inventory": "Inventory",
  "inventory.description":
    "Phase 5 inventory now covers material cards, item groups, item categories, units of measure, warehouses, stock movements, and costing policy.",
  "inventory.button.newItem": "New Material",
  "inventory.button.create": "Create Material",
  "inventory.button.edit": "Edit Material",
  "inventory.editor.createTitle": "Create Material / Item Card",
  "inventory.editor.editTitle": "Edit Material / Item Card",
  "inventory.field.name": "Material Name",
  "inventory.field.itemGroup": "Item Group",
  "inventory.field.itemCategory": "Item Category",
  "inventory.field.unitOfMeasure": "Base Unit of Measure",
  "inventory.detail.itemGroup": "Item Group",
  "inventory.detail.itemCategory": "Item Category",
  "inventory.filters.allItemGroups": "All item groups",
  "inventory.filters.allItemCategories": "All item categories",
  "inventory.placeholder.selectItemGroup": "Select an active item group",
  ...
  "inventory.workspace.itemGroups": "Item Groups",
  "inventory.workspace.itemCategories": "Item Categories",
  "inventory.workspace.unitsOfMeasure": "Units of Measure",
  "inventory.button.newItemGroup": "New Item Group",
  "inventory.button.editItemGroup": "Edit Item Group",
  "inventory.button.createItemGroup": "Create Item Group",
  "inventory.itemGroups.title": "Item Groups",
  "inventory.itemGroups.description":
    "Manage the top-level inventory grouping used by material cards and reporting.",
  "inventory.itemGroups.filters.search":
    "Search by group code, name, description, or parent group...",
  "inventory.itemGroups.empty": "No item groups match the current filters.",
  "inventory.itemGroups.categoryCount": "{count} categories",
  "inventory.itemGroups.itemCount": "{count} materials",
  "inventory.itemGroups.field.code": "Group Code",
  "inventory.itemGroups.field.name": "Group Name",
  "inventory.itemGroups.field.parentGroup": "Parent Group",
  "inventory.itemGroups.detail.categoryCount": "Categories",
  "inventory.itemGroups.detail.itemCount": "Materials",
  "inventory.itemGroups.details.empty": "Select an item group to review its details.",
  "inventory.itemGroups.editor.createTitle": "Create Item Group",
  "inventory.itemGroups.editor.editTitle": "Edit Item Group",
  "inventory.itemGroups.confirm.deactivate": "Deactivate this item group?",
  "inventory.button.newItemCategory": "New Item Category",
  "inventory.button.editItemCategory": "Edit Item Category",
  "inventory.button.createItemCategory": "Create Item Category",
  "inventory.itemCategories.title": "Item Categories",
  "inventory.itemCategories.description":
    "Manage sub-classifications under item groups and enforce the group/category/material hierarchy.",
  "inventory.itemCategories.filters.search":
    "Search by category code, name, description, or item group...",
  "inventory.itemCategories.filters.allGroups": "All item groups",
  "inventory.itemCategories.empty": "No item categories match the current filters.",
  "inventory.itemCategories.itemCount": "{count} materials",
  "inventory.itemCategories.field.code": "Category Code",
  "inventory.itemCategories.field.name": "Category Name",
  "inventory.itemCategories.field.itemGroup": "Item Group",
  "inventory.itemCategories.detail.itemCount": "Materials",
  "inventory.itemCategories.details.empty": "Select an item category to review its details.",
  "inventory.itemCategories.editor.createTitle": "Create Item Category",
  "inventory.itemCategories.editor.editTitle": "Edit Item Category",
  "inventory.itemCategories.confirm.deactivate": "Deactivate this item category?",
  "inventory.button.newUnit": "New Unit",
  "inventory.button.editUnit": "Edit Unit",
  "inventory.button.createUnit": "Create Unit",
  "inventory.units.title": "Units of Measure",
  "inventory.units.description":
    "Manage base units used by material cards and inventory transaction lines.",
  "inventory.units.filters.search":
    "Search by unit code, name, description, or type...",
  "inventory.units.empty": "No units of measure match the current filters.",
  "inventory.units.decimalPrecision": "{count} decimals",
  "inventory.units.itemCount": "{count} materials",
  "inventory.units.field.code": "Unit Code",
  "inventory.units.field.name": "Unit Name",
  "inventory.units.field.unitType": "Unit Type",
  "inventory.units.field.decimalPrecision": "Decimal Precision",
  "inventory.units.detail.itemCount": "Materials",
  "inventory.units.details.empty": "Select a unit of measure to review its details.",
  "inventory.units.editor.createTitle": "Create Unit of Measure",
  "inventory.units.editor.editTitle": "Edit Unit of Measure",
  "inventory.units.confirm.deactivate": "Deactivate this unit of measure?",
