...
Object.assign(arTranslations, {
  "inventory.description": "ØªØªØ¶Ù…Ù† Ø§Ù„Ù…Ø±Ø­Ù„Ø© Ø§Ù„Ø®Ø§Ù…Ø³Ø© Ù„Ù„Ù…Ø®Ø²ÙˆÙ† Ø§Ù„Ø¢Ù† Ø´Ø±ÙŠØ­ØªÙŠ Ø¨Ø·Ø§Ù‚Ø© Ø§Ù„ØµÙ†Ù ÙˆØ¨Ø·Ø§Ù‚Ø© Ø§Ù„Ù…Ø³ØªÙˆØ¯Ø¹ Ø¯Ø§Ø®Ù„ Ù‡ÙŠÙƒÙ„ Ø§Ù„Ù…Ø´Ø±ÙˆØ¹ Ø§Ù„Ø­Ø§Ù„ÙŠØŒ Ø¨ÙŠÙ†Ù…Ø§ ØªØ¨Ù‚Ù‰ Ø¨Ù‚ÙŠØ© Ø³ÙŠØ± Ø§Ù„Ø¹Ù…Ù„ Ø§Ù„Ù…Ø®Ø²Ù†ÙŠ Ù…Ø®Ø·Ø·Ø© Ù„Ù„ØªÙ†ÙÙŠØ° Ø§Ù„ØªØ¯Ø±ÙŠØ¬ÙŠ.",
  "inventory.button.newWarehouse": "Ù…Ø³ØªÙˆØ¯Ø¹ Ø¬Ø¯ÙŠØ¯",
  "inventory.button.editWarehouse": "ØªØ¹Ø¯ÙŠÙ„ Ø§Ù„Ù…Ø³ØªÙˆØ¯Ø¹",
  "inventory.button.createWarehouse": "Ø¥Ù†Ø´Ø§Ø¡ Ø§Ù„Ù…Ø³ØªÙˆØ¯Ø¹",
  "inventory.metrics.warehouses": "Ø§Ù„Ù…Ø³ØªÙˆØ¯Ø¹Ø§Øª",
  "inventory.metrics.activeWarehouses": "Ø§Ù„Ù…Ø³ØªÙˆØ¯Ø¹Ø§Øª Ø§Ù„Ù†Ø´Ø·Ø©",
  "inventory.items.title": "Ø¨Ø·Ø§Ù‚Ø© Ø§Ù„ØµÙ†Ù",
  "inventory.items.description": "Ø¥Ø¯Ø§Ø±Ø© Ø¥Ø¹Ø¯Ø§Ø¯ Ø§Ù„Ø£ØµÙ†Ø§Ù ÙˆØ§ÙØªØ±Ø§Ø¶ÙŠØ§Øª Ø§Ù„Ø­Ø³Ø§Ø¨Ø§Øª ÙˆØ¨ÙŠØ§Ù†Ø§Øª Ø¥Ø¹Ø§Ø¯Ø© Ø§Ù„Ø·Ù„Ø¨ ÙˆØ±Ø¨Ø· Ø§Ù„Ù…Ø³ØªÙˆØ¯Ø¹ Ø§Ù„Ù…ÙØ¶Ù„.",
  "inventory.warehouses.title": "Ø§Ù„Ù…Ø³ØªÙˆØ¯Ø¹Ø§Øª",
  "inventory.warehouses.description": "Ø¥Ø¯Ø§Ø±Ø© Ø¨Ø·Ø§Ù‚Ø§Øª Ø§Ù„Ù…Ø³ØªÙˆØ¯Ø¹Ø§Øª ÙˆÙ…ÙˆØ§Ù‚Ø¹ Ø§Ù„ØªØ®Ø²ÙŠÙ† Ø¨Ù…Ø§ ÙÙŠ Ø°Ù„Ùƒ Ù…ÙˆØ§Ù‚Ø¹ Ø§Ù„ØªØ±Ø§Ù†Ø²ÙŠØª ÙˆØ¶ÙˆØ§Ø¨Ø· Ø§Ù„Ø§Ø®ØªÙŠØ§Ø± Ø§Ù„Ù†Ø´Ø·.",
  "inventory.warehouses.loading": "Ø¬Ø§Ø±Ù ØªØ­Ù…ÙŠÙ„ Ø§Ù„Ù…Ø³ØªÙˆØ¯Ø¹Ø§Øª...",
  "inventory.warehouses.empty": "Ù„Ø§ ØªÙˆØ¬Ø¯ Ù…Ø³ØªÙˆØ¯Ø¹Ø§Øª Ù…Ø·Ø§Ø¨Ù‚Ø© Ù„Ù„ÙÙ„Ø§ØªØ± Ø§Ù„Ø­Ø§Ù„ÙŠØ©.",
  "inventory.warehouses.filters.search": "Ø§Ø¨Ø­Ø« Ø¨Ø§Ù„Ø±Ù…Ø² Ø£Ùˆ Ø§Ù„Ø§Ø³Ù… Ø£Ùˆ Ø§Ù„Ø¹Ù†ÙˆØ§Ù† Ø£Ùˆ Ø§Ù„Ù…Ø³Ø¤ÙˆÙ„...",
  "inventory.warehouses.filters.allModes": "ÙƒÙ„ Ø£Ù†Ù…Ø§Ø· Ø§Ù„Ù…Ø³ØªÙˆØ¯Ø¹",
  "inventory.warehouses.filters.storageOnly": "ØªØ®Ø²ÙŠÙ† ÙÙ‚Ø·",
  "inventory.warehouses.filters.transitOnly": "ØªØ±Ø§Ù†Ø²ÙŠØª ÙÙ‚Ø·",
  "inventory.warehouses.mode.storage": "ØªØ®Ø²ÙŠÙ†",
  "inventory.warehouses.mode.transit": "ØªØ±Ø§Ù†Ø²ÙŠØª / ØªØ¬Ù…ÙŠØ¹",
  "inventory.warehouses.itemCount": "{count} Ø£ØµÙ†Ø§Ù Ù…Ø±ØªØ¨Ø·Ø©",
  "inventory.warehouses.field.code": "Ø±Ù…Ø² Ø§Ù„Ù…Ø³ØªÙˆØ¯Ø¹",
  "inventory.warehouses.field.codeHint": "Ø§ØªØ±ÙƒÙ‡ ÙØ§Ø±ØºÙ‹Ø§ Ù„ÙŠÙ‚ÙˆÙ… Ø§Ù„Ù†Ø¸Ø§Ù… Ø¨ØªÙˆÙ„ÙŠØ¯Ù‡.",
  "inventory.warehouses.field.name": "Ø§Ø³Ù… Ø§Ù„Ù…Ø³ØªÙˆØ¯Ø¹",
  "inventory.warehouses.field.address": "Ø§Ù„Ø¹Ù†ÙˆØ§Ù†",
  "inventory.warehouses.field.responsiblePerson": "Ø§Ù„Ù…Ø³Ø¤ÙˆÙ„",
  "inventory.warehouses.field.mode": "Ù†Ù…Ø· Ø§Ù„Ù…Ø³ØªÙˆØ¯Ø¹",
  "inventory.warehouses.detail.mode": "Ø§Ù„Ù†Ù…Ø·",
  "inventory.warehouses.detail.itemCount": "Ø§Ù„Ø£ØµÙ†Ø§Ù Ø§Ù„Ù…Ø±ØªØ¨Ø·Ø©",
  "inventory.warehouses.details.empty": "Ø§Ø®ØªØ± Ù…Ø³ØªÙˆØ¯Ø¹Ù‹Ø§ Ù„Ø¹Ø±Ø¶ ØªÙØ§ØµÙŠÙ„Ù‡.",
  "inventory.warehouses.editor.createTitle": "Ø¥Ù†Ø´Ø§Ø¡ Ù…Ø³ØªÙˆØ¯Ø¹",
  "inventory.warehouses.editor.editTitle": "ØªØ¹Ø¯ÙŠÙ„ Ø§Ù„Ù…Ø³ØªÙˆØ¯Ø¹",
  "inventory.warehouses.confirm.deactivate": "Ù‡Ù„ ØªØ±ÙŠØ¯ ØªØ¹Ø·ÙŠÙ„ Ù‡Ø°Ø§ Ø§Ù„Ù…Ø³ØªÙˆØ¯Ø¹ØŸ",
  "inventory.placeholder.selectWarehouse": "Ø§Ø®ØªØ± Ù…Ø³ØªÙˆØ¯Ø¹Ù‹Ø§",
  "inventory.next.description": "ØªÙ… Ø§Ù„Ø¢Ù† ØªÙ†ÙÙŠØ° Ø´Ø±ÙŠØ­ØªÙŠ Ø¨Ø·Ø§Ù‚Ø© Ø§Ù„ØµÙ†Ù ÙˆØ§Ù„Ù…Ø³ØªÙˆØ¯Ø¹Ø§Øª. Ø£Ù…Ø§ Ø¨Ù‚ÙŠØ© Ø³ÙŠØ± Ø§Ù„Ø¹Ù…Ù„ Ø§Ù„Ù…Ø®Ø²Ù†ÙŠ ÙÙ…Ø§ Ø²Ø§Ù„Øª Ù…Ø®Ø·Ø·Ø© Ø¨Ø´ÙƒÙ„ ØµØ±ÙŠØ­ Ø­ØªÙ‰ ÙŠØªÙ… ØªÙ†ÙÙŠØ° ÙˆØ­Ø¯Ø§ØªÙ‡Ø§ Ø§Ù„Ù…Ø§Ù„ÙƒØ©.",
});
